...
function PromtBar() {
  ...
  return (
    <motion.div initial={{width:0}} animate={{width:"100%"}} transition={{duration:0.8}} className='absolute bottom-10 flex justify-between rounded-xl px-4 py-4 w-full bg-zinc-200'>
